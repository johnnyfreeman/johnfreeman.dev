<div>
    ...
    <ul class="flex flex-wrap font-sans">
        ...
        <li class="inline mt-2 mr-2"><a class="inline-block uppercase tracking-wide bg-blue-400 light:bg-blue-600 rounded text-white hover:bg-blue-500 light:hover:bg-blue-700 px-3 py-1" href="{{ url('open-source') }}" data-action="click->terminal#execute" data-terminal-input="open-source">Open Source</a></li>
