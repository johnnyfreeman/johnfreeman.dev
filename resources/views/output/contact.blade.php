<div data-controller="contact output" data-target="terminal.output">
    ...
    <form action="" class="mt-3 w-full max-w-2xl font-sans bg-white rounded-lg shadow p-6" data-action="submit->contact#submit" data-target="contact.form" method="POST">
        ...
        <div class="flex flex-wrap -mx-3">
            <div class="w-full px-3">
                <button type="submit" class="uppercase tracking-wide bg-blue-500 light:bg-blue-600 rounded text-white text-xs hover:bg-blue-500 light:hover:bg-blue-700 px-3 py-2" data-target="contact.submit">Send</button>
            </div>
        </div>
    </form>
</div>
