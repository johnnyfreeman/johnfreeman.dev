...
<x-output :input="$input">
    <form action="{{ route('login') }}" class="w-full max-w-xl bg-nosferatu-100 focus-within:bg-white shadow p-6" method="POST">
        @csrf
        @honeypot
        ...
        <div class="space-y-6">
            <div class="flex space-x-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold mb-2 text-nosferatu-800">Ah ah ah!</h1>
