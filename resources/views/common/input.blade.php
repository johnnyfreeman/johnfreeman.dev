<p class="group mt-8 text-indigo-400 light:text-indigo-600 h-8" data-controller="clipboard">
    ...
    <span class="mr-1"><input data-target="output.input terminal.input clipboard.copyable" class="appearance-none border-0 bg-transparent" readonly type="text" value="{{ $input }}" /></span>
