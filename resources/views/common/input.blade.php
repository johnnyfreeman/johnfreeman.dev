...
<div class="group mt-8 text-indigo-400 light:text-indigo-600 h-12 flex items-center -mx-5 md:-mx-10 px-5 md:px-10 focus-within:bg-gray-900" data-controller="clipboard">
    ...
    <input autocomplete="off" class="bg-transparent w-full px-2 focus:outline-none" data-target="{{ $cache ? 'output.cache' : '' }} terminal.history clipboard.copyable" readonly name="input" type="text" value="{{ $input }}">
