...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function submit(e) {
      ...
      return _api__WEBPACK_IMPORTED_MODULE_1__["default"].post("contact", new FormData(this.formTarget)).then(function (response) {
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function execute(e) {
      ...
      return _api__WEBPACK_IMPORTED_MODULE_1__["default"].get("partials/".concat(input)).then(function (response) {
        return response.data;
