...
axios__WEBPACK_IMPORTED_MODULE_0___default.a.defaults.headers.common['Accept'] = 'text/html, */*';
axios__WEBPACK_IMPORTED_MODULE_0___default.a.defaults.headers.common['X-Requested-With'] = 'XMLHttpRequest';
axios__WEBPACK_IMPORTED_MODULE_0___default.a.defaults.headers.common['X-CSRF-TOKEN'] = document.head.querySelector('meta[name="csrf-token"]').content;
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function submit(e) {
      ...
      return _api__WEBPACK_IMPORTED_MODULE_1__["default"].post("contact", new FormData(this.formTarget)).then(function (output) {
        return window.terminal.write(output);
      })["finally"](this.replaceSubmitHTML.bind(this));
    } // Private

  }, {
    key: "replaceSubmitHTML",
    value: function replaceSubmitHTML() {
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function execute(event) {
      ...
      return _api__WEBPACK_IMPORTED_MODULE_1__["default"].get("commands/".concat(input)).then(this.write.bind(this));
    }
  }, {
